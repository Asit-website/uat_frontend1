...
const DeleteLeadStatus = async (id) => {
   const data = await deleteReq(`${baseUrl}/lead/deleteLeadStatus/${id}`, true);
   return data;
};
   
const DeleteLeadSouce = async (id) => {
   const data = await deleteReq(`${baseUrl}/lead/deleteLeadStatus/${id}`, true);
   return data;
};
