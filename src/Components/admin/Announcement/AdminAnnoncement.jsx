                        ...
                        <form onSubmit={() => {
                            ...
                            <div className="allInputFileds">
                                ...
                                <label htmlFor="title" >
                                    ...
                                    <input id='title' name='title' onChange={changeHandler} value={formdata?.title} type="text" placeholder='Enter Annoucement Title' />
                                </label>

                                <label htmlFor="Branch" >
                                    <p>Branch</p>
                                    <select onChange={changeHandler} name="Branch" id="Branch" value={formdata?.Branch}>
                                ...
                                <label htmlFor="Department" >
                                    ...
                                    <select onChange={(e) => {
                                        changeHandler(e);
                                    }} name="Department" id="Department" value={formdata?.Department}>
                                ...
                                <label htmlFor="startDate" >
                                    ...
                                    <input id='startDate' name='startDate' value={formdata.startDate} onChange={changeHandler} type="date" />
                                </label>

                                <label htmlFor="endDate" >
                                    <p>Announcement End Date</p>
                                    <input value={formdata?.endDate} onChange={changeHandler} name='endDate' id='endDate' type="date" />
                                </label>

                                <div className='anDesWrap'>
                                    <p>Announcement Description</p>
                                    <textarea onChange={changeHandler} value={formdata?.description} name="description" id="description" cols="30" rows="10" placeholder='Enter Annoucement Title'></textarea>
                                </div>
