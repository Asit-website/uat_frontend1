      ...
      <div className="employee-dash h-full">
                    ...
                    <tbody>
                      {data.map((item, index) => (
                        <tr key={index} className="bg-white border-b fdf">
                          ...
                          <td className="px-6 py-4 taskAns">{item?.terminationDate}</td>
        ...
        {popup1 && (
          ...
          <label htmlFor="terminationDate">
            ...
            <p>Description</p>
            <textarea onChange={changeHandler} value={formdata?.description}  name="description" rows="8" cols="50" placeholder="Enter Description">
