               ...
               <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                 ...
                 <thead className="text-xs text-gray-700 uppercase bg-white-50 dark:bg-white-700 dark:text-gray-400">
                   <tr>
                     ...
                     <th scope="col" className="px-6 py-3 bg-white">
                       <div className="flex items-center">
                       <button type="button" class="px-6 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Started</button>
                         <a href="#">
                           <svg
                             className="w-3 h-3 ms-1.5"
                             aria-hidden="true"
        ...
        {popup1 && (
          <div className="allPopupWrap">
            <div className="popup1 awardpopup">
              ...
              <label htmlFor="">
                <p>Description</p>
                <textarea id="w3review" name="w3review" rows="6" cols="50" placeholder="Enter Description"></textarea>
              </label>
              </div>
              {/* <div/> */}
