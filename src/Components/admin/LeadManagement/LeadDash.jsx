                        ...
                        <div className="leadThings">
                            ...
                            <div className="lead_content2">
                                <div className="leads_btn">
                                    <button onClick={()=> window.location.href = "/adminDash/leadDash"} className="refresh"><span className="ref1">Refresh</span> <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                   ...
                                   <NavLink to="/adminDash/myLead"><button className="lead_btn">My Leads</button></NavLink>
                                </div>
                            </div>
                        </div>
