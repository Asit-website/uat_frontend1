...
const LeadDash2 = ({ setAlert, pop, setPop }) => {
    ...
    const { user , getLead , getTaskApi, getMeetApi , deleteTaskapi , deleteMeetapi } = useMain();
                        ...
                        <div className="leadThings">
                            ...
                            <div className="lead_content2">
                                <div className="leads_btn">
                                    <button onClick={()=> window.location.href = "/employeeDash/leadDash"} className="refresh"><span className="ref1">Refresh</span> <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="lead_dash_box sing11">
                                    <div className="lead_contents">
                                        <svg width="42" height="43" viewBox="0 0 42 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <rect y="0.5" width="42" height="42" rx="8" fill="url(#paint0_linear_410_608)" />
                                            <path d="M29 15.5H26V13.5C26 12.397 25.103 11.5 24 11.5H18C16.897 11.5 16 12.397 16 13.5V15.5H13C11.897 15.5 11 16.397 11 17.5V28.5C11 29.603 11.897 30.5 13 30.5H29C30.103 30.5 31 29.603 31 28.5V17.5C31 16.397 30.103 15.5 29 15.5ZM24 13.5V15.5H18V13.5H24ZM17 17.5H29V20.5H13V17.5H17ZM13 28.5V22.5H19V24.5H23V22.5H29L29.001 28.5H13Z" fill="#0B56E4" />
                                            <defs>
                                                <linearGradient id="paint0_linear_410_608" x1="1" y1="5.5" x2="38.5" y2="39" gradientUnits="userSpaceOnUse">
                            ...
                            >
                              <div>
                                    ...
                                    <li className="sysok">
                                      <a
                                        onClick={() => {
                                          ...
                                          navigate(`/adminDash/importLead/${task?.LeadId}`, { state: { type:"task" , data1:task} })
                                                                                }}
                                ...
                                <div className="prev_next">
                                    ...
                                    <div className="next">
                                        <button><span>Next</span><svg width="8" height="10" viewBox="0 0 8 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      ...
                      >
                        <li className="sysok">
                          <a
 onClick={() => {
  navigate(`/employeeDash/importLead/${meet?.LeadId}`, { state: { type:"meet" , data1:meet} })
}}
                            className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                          >
                            <svg
